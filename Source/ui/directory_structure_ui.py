...
# Window Title
root.title("DirectoryStructureTool")
...
productionDirectorylabel = ttk.Label(root, text="Enter, name of CGI Production", style="BW.TLabel")
...
quitApplicati = ttk.Label(root, text="Do or do not, there is no try.\n - Jedi Master")
quitApplicationlabel.pack()
